...
using QnxTest.PageObjects.BetMarkets.VirtualPage;
using System;
...
namespace QnxTest.Tests.BetMarkets.VirtualPage
{
    public class BetMarketsVirtualIFrameVerificationMobile : BaseWebDriver
    {
        ...
        public void VirtualGameIFrameVerification()
        {
            ...
            var virtualPageObject = new BetMarketsVirtualPageObject(Driver, DefaultWait);
