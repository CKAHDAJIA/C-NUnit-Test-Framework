...
//{
//    public class LuxBet88CasinoIFrameVerification : BaseWebDriver
//    {
...
//            Assert.AreEqual(size.Width, 940); // TODO fix to the differance existing with the default padding 
