...
using QnxTest.PageObjects.CricPlayers.SlotPage;
using System;
...
namespace QnxTest.Tests.CricPlayers.SlotPage
{
    public class CricPlayersSlotIFrameVerificationMobile : BaseWebDriver
    {
        ...
        public void SlotGameIFrameVerificationMobile()
        {
            ...
            var slotPageObject = new CricPlayersSlotPageObject(Driver, DefaultWait);
