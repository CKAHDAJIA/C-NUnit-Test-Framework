...
namespace QnxTest.PageObjects.Hachislot.LoginPage
{
    internal class HachislotLoginPageObject : BaseLoginPageObject
    {
        ...
        public HachislotLoginPageObject(IWebDriver driver, WebDriverWait wait) : base(driver, wait)
        {
        }
    }
}
