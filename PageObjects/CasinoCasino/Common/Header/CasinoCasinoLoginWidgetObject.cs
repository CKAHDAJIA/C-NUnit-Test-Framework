...
namespace QnxTest.PageObjects.CasinoCasino.Common.Header
{
    internal class CasinoCasinoLoginWidgetObject : BaseLoginWidgetObject
    {
        ...
        public CasinoCasinoLoginWidgetObject(IWebDriver driver, WebDriverWait wait) : base(driver, wait)
        {
        }
    }
}
