...
namespace QnxTest.PageObjects.BetMarkets.Common.Header
{
    internal class BetMarketsLoginWidgetObject : BaseLoginWidgetObject
    {
        ...
        public BetMarketsLoginWidgetObject(IWebDriver driver, WebDriverWait wait) : base(driver, wait)
        {
        }
    }
}
