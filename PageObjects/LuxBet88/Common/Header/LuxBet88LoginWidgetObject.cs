...
namespace QnxTest.PageObjects.LuxBet88.Common.Header
{
    internal class LuxBet88LoginWidgetObject : BaseLoginWidgetObject
    {

        [FindsBy(How = How.XPath, Using = "//button[@class='mf button mlogin-btn']")]
        ...
        public LuxBet88LoginWidgetObject(IWebDriver driver, WebDriverWait wait) : base(driver, wait)
        {
        }
    }
}
