...
namespace QnxTest.PageObjects.LibertyCasino.LoginPage
{
    internal class LibertyCasinoLoginPageObject : BaseLoginPageObject
    {
        ...
        public LibertyCasinoLoginPageObject(IWebDriver driver, WebDriverWait wait) : base(driver, wait)
        {
        }
    }
}
