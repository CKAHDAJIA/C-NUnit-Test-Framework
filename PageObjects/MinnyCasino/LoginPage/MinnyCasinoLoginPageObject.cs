...
namespace QnxTest.PageObjects.MinnyCasino.LoginPage
{
    internal class MinnyCasinoLoginPageObject : BaseLoginPageObject
    {
        ...
        public MinnyCasinoLoginPageObject(IWebDriver driver, WebDriverWait wait) : base(driver, wait)
        {
        }
    }
}
