...
namespace QnxTest.PageObjects.GC88.LoginPage
{
    internal class GC88LoginPageObject : BaseLoginPageObject
    {
        ...
        public GC88LoginPageObject(IWebDriver driver, WebDriverWait wait) : base(driver, wait)
        {
        }
    }
}
